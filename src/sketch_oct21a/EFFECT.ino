...
void demo_modeA() {
  ...
  one_color_all(255, 0, 0); LEDS.show(); delay(1200); butt1.tick();
  one_color_all(0, 255, 0); LEDS.show(); delay(1200); butt1.tick();
  one_color_all(0, 0, 255); LEDS.show(); delay(1200); butt1.tick();
  one_color_all(255, 255, 0); LEDS.show(); delay(1200); butt1.tick();
  one_color_all(0, 255, 255); LEDS.show(); delay(1200); butt1.tick();
  one_color_all(255, 0, 255); LEDS.show(); delay(1200); butt1.tick();
}
