...
#define LED_PIN_1 6
#define NUM_LEDS_1 20  // Укажите количество светодиодов в Левой ножке стола
CRGB leds1[NUM_LEDS_1];

// Настройки для вертикальной ножки
#define LED_PIN_2 4
#define NUM_LEDS_2 20  // Укажите количество светодиодов в Правой ножке стола
